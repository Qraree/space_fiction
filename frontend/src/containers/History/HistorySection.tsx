...
const HistorySection = () => {
    return (
        <div className={styles.wrapper}>
            <h1>History of rocket science</h1>
            <hr />
            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut nibh ipsum, rhoncus non lorem id, ultricies pretium risus. Praesent placerat viverra facilisis. Donec placerat varius faucibus. In vulputate sem libero, scelerisque porta augue bibendum non. Curabitur aliquet lobortis massa. Etiam blandit rhoncus condimentum. Maecenas risus turpis, tempus ut vestibulum in, scelerisque ut velit. Fusce est urna, condimentum vitae magna non, varius tristique augue. Suspendisse a interdum neque. In feugiat quam quam, eu tincidunt lorem fermentum vel. Interdum et malesuada fames ac ante ipsum primis in faucibus. Etiam feugiat pharetra dapibus. Nunc sed sem eget turpis ultricies dapibus ut sed est. In efficitur blandit ullamcorper. Suspendisse mollis lacus at purus ornare, id fringilla purus facilisis. Vivamus eget pretium risus.</p>
            <p>
                ...
                Nullam ut est massa. Sed et quam ut leo mattis dictum. Sed vulputate porta sem. Fusce porttitor vel lorem non faucibus. Aenean finibus ut elit in porta. Donec urna ex, luctus a blandit vitae, consectetur sit amet arcu. In tempor a elit ut accumsan. Morbi sagittis, enim ac suscipit convallis, magna sem convallis nunc, ut aliquam urna purus eu dui.
                ...
                Proin diam ante, euismod in eleifend vel, ullamcorper a sem. Maecenas et tellus congue, efficitur purus quis, rutrum risus. Donec imperdiet rhoncus metus in iaculis. Cras euismod lectus interdum lacinia lacinia.
